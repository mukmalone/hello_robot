...
#define K_P 0.55 // P constant
#define K_I 0.3 // I constant
#define K_D 0.125 // D constant

//define your robot' specs here
#define MAX_RPM 330               // motor's maximum RPM
#define COUNTS_PER_REV 1318       // wheel encoder's no of ticks per rev
...
#define FR_WHEELS_DISTANCE 0.165   // distance between front and rear wheels. Ignore this if you're on 2WD/ACKERMANN
